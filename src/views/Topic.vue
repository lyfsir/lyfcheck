      ...
      <el-main>
        ...
        <div class="topic_main">
          <div class="topic_left">
            ...
            <ul class="topic_type">
              <li><a href="javascript:void(0);" :class="{on : hasA}" @click="all">全部</a></li>
              <li><a href="javascript:void(0);" :class="{on2 : !hasA}" @click="newer">最新</a></li>
            </ul>
          </div>
        ...
        methods: {
            ...
            getData() {
                ...
                reqSearchTopic(searchParam).then((res) => {
                    console.log("res", res)
                    this.searchTopic = res.data.topicInfosModels;
